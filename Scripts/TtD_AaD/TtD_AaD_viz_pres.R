...
pdf(paste0("../Figures/Final/Presentation/",arr,"_univ_base_or.pdf"), width = 5, height = 5)
p1
dev.off()
pdf(paste0("../Figures/Final/Presentation/",arr,"_univ_base_pval.pdf"), width = 5, height = 5)
p2
dev.off()
