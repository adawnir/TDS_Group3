...
### TDS Project -- sgPLS stability selection on bladder on HPC for extract output
...
pdf("sg_Cali_plot_bladder.1.pdf", width=10, height=7)
...
saveRDS(sg_out_1, "sgPLS_stability_selection_bladder.1.rds")
...
saveRDS(sg_out_2, "sgPLS_stability_selection_bladder.2.rds")
