...
### TDS Project -- Stability selection sPLS loading coefficients & selection proportion Visualisation
...
##### Load data--
load_lung.1 <- readRDS("../../Results/PLS/loadings_lung_1.rds")
load_lung.2 <- readRDS("../../Results/PLS/loadings_lung_2.rds")
load_bladder.1 <- readRDS("../../Results/PLS/loadings_bladder_1.rds")
load_bladder.2 <- readRDS("../../Results/PLS/loadings_bladder_2.rds")
...
{pdf("sPLS_LC_lung.pdf", width=10, height=7)
  par(mar=c(17, 1, 3, 5))
  plot(LC_lung,
       xaxt="n", yaxt="n",
...
{pdf("sPLS_LC_bladder.pdf", width=10, height=7)
  par(mar=c(17, 1, 3, 5))
  plot(LC_bladder,
       xaxt="n", yaxt="n",
       type="h", lwd=1, col=c(NA, mycolours[1], NA, mycolours[2], NA),
...
##### Load data--
out_lung_1 <- readRDS("../../Results/PLS/sPLS_stability_selection_lung.1.rds")
out_lung_2 <- readRDS("../../Results/PLS/sPLS_stability_selection_lung.2.rds")
out_bladder_1 <- readRDS("../../Results/PLS/sPLS_stability_selection_bladder.1.rds")
out_bladder_2 <- readRDS("../../Results/PLS/sPLS_stability_selection_bladder.2.rds")
...
{pdf("sPLS_selprop_lung.pdf", width=10, height=7)
  par(mar=c(17, 1, 3, 5))
  plot(SP_lung,
       xaxt="n", yaxt="n",
       type="h", lwd=1, col=c(NA, mycolours[1], NA, mycolours[2], NA),
...
{pdf("sPLS_selprop_bladder.pdf", width=10, height=7)
  par(mar=c(17, 1, 3, 5))
  plot(SP_bladder,
       xaxt="n", yaxt="n",
       type="h", lwd=1, col=c(NA, mycolours[1], NA, mycolours[2], NA),
