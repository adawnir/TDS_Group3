# base spls with sample = nvsm size
# by ines on april 22
rm(list=ls())
...
## Create directories
ifelse(dir.exists("../Figures/nvsm/base/spls"),"",dir.create("../Figures/nvsm/base/spls")) ### Change path for other stratification
ifelse(dir.exists("../Results/nvsm/base/spls"),"",dir.create("../Results/nvsm/base/spls")) ### Change path for other stratification
...
# Save plots
pdf(paste0("../Figures/nvsm/base/spls/out_",arr,".pdf"), height=5, width=12)
CalibrationPlot(out)
dev.off()
...
pdf(paste0("../Figures/nvsm/base/spls/out_unconstr_2d_",arr,".pdf"), height=5, width=12) ### Change path for other stratification
...
pdf(paste0("../Figures/nvsm/base/spls/stab_mat_",arr,".pdf"), height=8, width=12) ### Change path for other stratification
...
# Save data sets
saveRDS(out, paste0("../Results/nvsm/base/spls/out_",arr,".rds")) ### Change path for other stratification
saveRDS(selprop, paste0("../Results/nvsm/base/spls/selprop_",arr,".rds")) ### Change path for other stratification
saveRDS(average_beta, paste0("../Results/nvsm/base/spls/beta_",arr,".rds")) ### Change path for other stratification
