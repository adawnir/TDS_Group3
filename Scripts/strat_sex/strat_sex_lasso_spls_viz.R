...
colnames=names(lasso_selprop_lung.f.1)
...
beta_lung.f=foo2(lasso_beta_lung.f.1, lasso_beta_lung.f.2,
                 spls_beta_lung.f.1,spls_beta_lung.f.2,myorder)
...
spls_selprop_lung.m=foo(spls_selprop_lung.m.1,
                      ...
                      myorder)
beta_lung.m=foo2(lasso_beta_lung.m.1, lasso_beta_lung.m.2,
                 spls_beta_lung.m.1,spls_beta_lung.m.2,myorder)
...
beta_bladder.f=foo2(lasso_beta_bladder.f.1, lasso_beta_bladder.f.2,
                 spls_beta_bladder.f.1,spls_beta_bladder.f.2,myorder)
# bladder Male
...
spls_selprop_bladder.m=foo(spls_selprop_bladder.m.1,
                      ...
                      myorder)
beta_bladder.m=foo2(lasso_beta_bladder.m.1, lasso_beta_bladder.m.2,
                 spls_beta_bladder.m.1,spls_beta_bladder.m.2,myorder)
...
## Female
# Lung
pi_spls=c(spls_hat_params_lung.f.1[2],spls_hat_params_lung.f.2[2]) # sPLS Selection proportion threshold
pi_lasso=c(lasso_hat_params_lung.f.1[2],lasso_hat_params_lung.f.2[2]) # LASSO Selection proportion threshold
...
# Bladder
pi_spls=c(spls_hat_params_bladder.f.1[2],spls_hat_params_bladder.f.2[2]) # sPLS Selection proportion threshold
pi_lasso=c(lasso_hat_params_bladder.f.1[2],lasso_hat_params_bladder.f.2[2]) # LASSO Selection proportion threshold
...
## Male
pi_spls=c(spls_hat_params_lung.m.1[2],spls_hat_params_lung.m.2[2]) # sPLS Selection proportion threshold
pi_lasso=c(lasso_hat_params_lung.m.1[2],lasso_hat_params_lung.m.2[2]) # LASSO Selection proportion threshold
file_path="lung_male"
...
# Bladder
pi_spls=c(spls_hat_params_bladder.m.1[2],spls_hat_params_bladder.m.2[2]) # sPLS Selection proportion threshold
pi_lasso=c(lasso_hat_params_bladder.m.1[2],lasso_hat_params_bladder.m.2[2]) # LASSO Selection proportion threshold
...
xlim=c(0.25,1.75)
ylim=c(-0.25,0.75)
beta_lung.f$var_cat=rep(variable_cat,2)
beta_lung.f$label=rep(1:(nrow(beta_lung.f)/2), 2)
beta_lung.f$mycolour_point=c(lighten(rep(mycolours,times=c(18,28,8,16,28)),0.2),rep(mycolours,times=c(18,28,8,16,28)))
beta_lung.f$mycolour_lab=darken(beta_lung.f$mycolour_point, amount=0.5)
p1=ggplot(beta_lung.f, aes(or, load,
  ...
  geom_point(aes(shape=model),colour=beta_lung.f$mycolour_point) +
  scale_shape_manual(values=c(17, 19)) +
  geom_text_repel(color=beta_lung.f$mycolour_lab,
                  nudge_y = 0.02,
                  nudge_x = 0.02,
...
xlim=c(0.5,1.5)
ylim=c(-0.25,0.55)
beta_bladder.f$var_cat=rep(variable_cat,2)
beta_bladder.f$label=rep(1:(nrow(beta_bladder.f)/2), 2)
beta_bladder.f$mycolour_point=c(lighten(rep(mycolours,times=c(18,28,8,16,28)),0.2),rep(mycolours,times=c(18,28,8,16,28)))
beta_bladder.f$mycolour_lab=darken(beta_bladder.f$mycolour_point, amount=0.5)
p2=ggplot(beta_bladder.f, aes(or, load, label=ifelse(((abs(or-1)<0.1&load==0)|(or==1&abs(load)<0.1)),
                                                     "",label))) +
  geom_vline(aes(xintercept = 1),linetype = "dashed",colour = "black") +
  geom_hline(aes(yintercept = 0),linetype = "dashed",colour = "black") +
  geom_point(aes(shape=model),colour=beta_bladder.f$mycolour_point) +
  scale_shape_manual(values=c(17, 19)) +
  geom_text_repel(color=beta_bladder.f$mycolour_lab,
                  nudge_y = 0.02,
                  nudge_x = 0.02,
                  size=3, segment.color="grey",
                  segment.size=0.2) +
...
xlim=c(0.25,1.75)
ylim=c(-0.25,0.75)
beta_lung.m$var_cat=rep(variable_cat,2)
beta_lung.m$label=rep(1:(nrow(beta_lung.m)/2), 2)
beta_lung.m$mycolour_point=c(lighten(rep(mycolours,times=c(18,28,8,16,28)),0.2),rep(mycolours,times=c(18,28,8,16,28)))
beta_lung.m$mycolour_lab=darken(beta_lung.m$mycolour_point, amount=0.5)
p3=ggplot(beta_lung.m, aes(or, load,
                           label=ifelse(((abs(or-1)<0.1&load==0)|(or==1&abs(load)<0.1)),
                                        "",label))) +
  geom_vline(aes(xintercept = 1),linetype = "dashed",colour = "black") +
  geom_hline(aes(yintercept = 0),linetype = "dashed",colour = "black") +
  geom_point(aes(shape=model),colour=beta_lung.m$mycolour_point) +
  scale_shape_manual(values=c(17, 19)) +
  geom_text_repel(color=beta_lung.m$mycolour_lab,
                  nudge_y = 0.02,
                  nudge_x = 0.02,
                  size=3, segment.color="grey",
                  segment.size=0.2) +
...
xlim=c(0.5,1.5)
ylim=c(-0.25,0.55)
beta_bladder.m$var_cat=rep(variable_cat,2)
beta_bladder.m$label=rep(1:(nrow(beta_bladder.m)/2), 2)
beta_bladder.m$mycolour_point=c(lighten(rep(mycolours,times=c(18,28,8,16,28)),0.2),rep(mycolours,times=c(18,28,8,16,28)))
beta_bladder.m$mycolour_lab=darken(beta_bladder.m$mycolour_point, amount=0.5)
p4=ggplot(beta_bladder.m, aes(or, load, label=ifelse(((abs(or-1)<0.1&load==0)|(or==1&abs(load)<0.1)),
                                                     "",label))) +
  geom_vline(aes(xintercept = 1),linetype = "dashed",colour = "black") +
  geom_hline(aes(yintercept = 0),linetype = "dashed",colour = "black") +
  geom_point(aes(shape=model),colour=beta_bladder.m$mycolour_point) +
  scale_shape_manual(values=c(17, 19)) +
  geom_text_repel(color=beta_bladder.m$mycolour_lab,
                  nudge_y = 0.02,
                  nudge_x = 0.02,
                  size=3, segment.color="grey",
                  segment.size=0.2) +
...
library(cowplot)
pdf("../Figures/Report/sex_or_load_grid.pdf", width=10, height=10)
plot_grid(p1, p3, p2, p4, nrow = 2, labels = c('A', 'B','C','D'))
# extract the legend from one of the plots
dev.off()

pdf("../Figures/Presentation/sex_or_load_grid.pdf", width=20, height=5)
