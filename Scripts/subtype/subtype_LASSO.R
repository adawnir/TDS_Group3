...
## Load data set
#arr=paste0(rep(c("lung","bladder"),each=4),".",rep(c("f","m"),each=2),".",1:2)[m] # REPLACE WITH DATASET?
#dat=readRDS(paste0("../Results/strat_sex_lasso/",arr,"_denoised.rds"))
...
# Create directories
ifelse(dir.exists("../Figures/subtype"),"",dir.create("../Figures/subtype"))
ifelse(dir.exists("../Results/subtype"),"",dir.create("../Results/subtype"))
...
# Save
saveRDS(out, paste0("../Results/strat_sex_lasso/out_",arr,".rds"))
saveRDS(average_beta, paste0("../Results/strat_sex_lasso/average_beta_",arr,".rds"))
saveRDS(selprop, paste0("../Results/strat_sex_lasso/selprop_",arr,".rds"))
...
saveRDS(myaucs_table, paste0("../Results/strat_sex_lasso/auc_",arr,".rds"))
