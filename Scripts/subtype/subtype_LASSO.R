...
# Create directories
ifelse(dir.exists("../Figures/strat_site_lasso"),"",dir.create("../Figures/strat_site_lasso"))
...
out=CalibrateRegression(xdata=x, ydata=y, K=100, tau=0.5, verbose=FALSE,
                        family="binomial")
# Save plot
pdf(paste0("../Figures/strat_site_lasso/out_",arr,".pdf"), height=5, width=12)
CalibrationPlot(out)
dev.off()
...
# Save
saveRDS(out, paste0("../Results/strat_site_lasso/out_",arr,".rds")) ### Change path for other stratification
saveRDS(average_beta, paste0("../Results/strat_site_lasso/average_beta_",arr,".rds")) ### Change path for other stratification
saveRDS(selprop, paste0("../Results/strat_site_lasso/selprop_",arr,".rds")) ### Change path for other stratification
...
saveRDS(myaucs_table, paste0("../Results/strat_site_lasso/auc_",arr,".rds")) ### Change path for other stratification
