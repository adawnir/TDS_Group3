...
y=dat$case_status
x=dat[,-1]
train=readRDS(paste0("../Results/strat_edu_denoised/",arr,"_split.rds"))
y_train=y[train]
x_train=x[train,]
y_test=y[-train]
x_test=x[-train, ]
...
## Create directories
ifelse(dir.exists("../Figures/strat_edu_spls"),"",dir.create("../Figures/strat_edu_spls")) ### Change path for other stratification
ifelse(dir.exists("../Results/strat_edu_spls"),"",dir.create("../Results/strat_edu_spls")) ### Change path for other stratification
...
# Save plots
pdf(paste0("../Figures/strat_edu_spls/out_",arr,".pdf"), height=5, width=12)
CalibrationPlot(out)
dev.off()
...
pdf(paste0("../Figures/strat_edu_spls/out_unconstr_2d_",arr,".pdf"), height=5, width=12) ### Change path for other stratification
...
pdf(paste0("../Figures/strat_edu_spls/stab_mat_",arr,".pdf"), height=8, width=12) ### Change path for other stratification
...
# Save data sets
saveRDS(out, paste0("../Results/strat_edu_spls/out_",arr,".rds")) ### Change path for other stratification
saveRDS(selprop, paste0("../Results/strat_edu_spls/selprop_",arr,".rds")) ### Change path for other stratification
saveRDS(average_beta, paste0("../Results/strat_edu_spls/beta_",arr,".rds")) ### Change path for other stratification
...
saveRDS(myroc, paste0("../Results/strat_edu_spls/roc_",arr,".rds"))
