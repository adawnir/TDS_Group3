...
myspacing=6
xseq=rep(myspacing, nrow(fad))
xseq=cumsum(xseq)

mynames=rownames(fad)

mypch=18
mycex=0.45
background=TRUE
mycols=brewer.pal("Dark2", n = 6)

# horizontal
{pdf("../Figures/age_diag_lung_wk8.pdf", height = 10, width = 15)
  par(mar=c(17, 1, 3, 5))
  plotCI(x=xseq-1.5, y=fad$or_lung_young.1, li=fad$l95_lung_young.1, ui=fad$u95_lung_young.1, 
         ylim=c(0,10), 
         xlim=c(min(xseq), max(xseq)),
         xaxt="n", yaxt="n", pch=mypch, col=mycols[1], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="")
  xseqgreysep=c(min(xseq)-myspacing/2,apply(rbind(xseq[-1],xseq[-length(xseq)]),2,mean),max(xseq)+myspacing/2)
  if (background){
    for (k in seq(1,length(xseqgreysep),by=2)){
  ...
  plotCI(x=xseq-1.5, y=fad$or_lung_young.1, li=fad$l95_lung_young.1, ui=fad$u95_lung_young.1,
         ylim=c(0,10), 
         xaxt="n", yaxt="n", pch=mypch, col=mycols[1], lwd=1, cex=mycex+0.2, sfrac=0.001,
         ylab="",xlab="", add=TRUE)
  plotCI(x=xseq-0.5, y=fad$or_lung_young.2, li=fad$l95_lung_young.2, ui=fad$u95_lung_young.2, 
         ylim=c(0,10), #ylim=myrange,
         xaxt="n", yaxt="n", pch=15, col=mycols[2], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=2)
  plotCI(x=xseq+0.5, y=fad$or_lung_old.1, li=fad$l95_lung_old.1, ui=fad$u95_lung_old.1, 
         ylim=c(0,10), #ylim=myrange,
         xaxt="n", yaxt="n", pch=19, col=mycols[3], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=3)
  plotCI(x=xseq+1.5, y=fad$or_lung_old.2, li=fad$l95_lung_old.2, ui=fad$u95_lung_old.2, 
         ylim=c(0,10), #ylim=myrange,
         xaxt="n", yaxt="n", pch=4, col=mycols[4], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=4)
  axis(side=4, at=axTicks(2), cex.axis=0.7)
  mtext(side=4, text="Odds Ratio", line=2, cex.lab=0.7)
  mtext(side=3, text="Lung", line=2, cex.lab=0.7)
  abline(h=1, lty=2)
  for (k in 1:length(xseq)){
    mytext=mynames
    axis(side=1, at=xseq[k], labels=mytext[k], 
         col=ifelse(fad$logp_lung_old.1 > bonf & fad$logp_lung_old.2 > bonf & 
                    fad$logp_lung_young.1 > bonf & fad$logp_lung_young.2 > bonf, yes=mycols[3], no="black"),
         las=2, cex.axis=0.7)
  }
  legend("topright", pch = c(mypch, 15, 19, 4), col = mycols, 
         legend = c("<Median Age_Diag Base","<Median Age_Diag Smoking", ">Median Age_Diag Base",">Median Age_Diag Smoking"))
  dev.off()}

# Bladder

{pdf("../Figures/age_diag_bladder_wk8.pdf", height = 10, width = 15)
  par(mar=c(17, 1, 3, 5))
  plotCI(x=xseq-1.5, y=fad$or_bladder_young.1, li=fad$l95_bladder_young.1, ui=fad$u95_bladder_young.1, 
         ylim=c(0,6), 
         xlim=c(min(xseq), max(xseq)),
         xaxt="n", yaxt="n", pch=mypch, col=mycols[1], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="")
  ...
  plotCI(x=xseq-1.5, y=fad$or_bladder_young.1, li=fad$l95_bladder_young.1, ui=fad$u95_bladder_young.1,
         ...
         xaxt="n", yaxt="n", pch=mypch, col=mycols[1], lwd=1, cex=mycex+0.2, sfrac=0.001,
         ylab="",xlab="", add=TRUE)
  plotCI(x=xseq-0.5, y=fad$or_bladder_young.2, li=fad$l95_bladder_young.2, ui=fad$u95_bladder_young.2, 
         ylim=c(0,6), #ylim=myrange,
         xaxt="n", yaxt="n", pch=15, col=mycols[2], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=2)
  plotCI(x=xseq+0.5, y=fad$or_bladder_old.1, li=fad$l95_bladder_old.1, ui=fad$u95_bladder_old.1, 
         ylim=c(0,6), #ylim=myrange,
         xaxt="n", yaxt="n", pch=19, col=mycols[3], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=3)
  plotCI(x=xseq+1.5, y=fad$or_bladder_old.2, li=fad$l95_bladder_old.2, ui=fad$u95_bladder_old.2, 
         ylim=c(0,6), #ylim=myrange,
         xaxt="n", yaxt="n", pch=4, col=mycols[4], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=4)
  axis(side=4, at=axTicks(2), cex.axis=0.7)
  mtext(side=4, text="Odds Ratio", line=2, cex.lab=0.7)
  mtext(side=3, text="Bladder", line=2, cex.lab=0.7)
  abline(h=1, lty=2)
  for (k in 1:length(xseq)){
    mytext=mynames
    axis(side=1, at=xseq[k], labels=mytext[k], 
         col=ifelse(fad$logp_bladder_old.1 > bonf & fad$logp_bladder_old.2 > bonf & 
                      fad$logp_bladder_young.1 > bonf & fad$logp_bladder_young.2 > bonf, yes=mycols[3], no="black"),
         las=2, cex.axis=0.7)
  }
  legend("topright", pch = c(mypch, 15, 19, 4), col = mycols, 
         legend = c("<Median Age_Diag Base","<Median Age_Diag Smoking", ">Median Age_Diag Base",">Median Age_Diag Smoking"))
...
### TIME TO DIAGNOSIS PLOTS ----

### Load data----
lung_res_early.1 <- readRDS("../Results/univ/univ_lung_res_earlydiag_1.rds")
lung_res_early.2 <- readRDS("../Results/univ/univ_lung_res_earlydiag_2.rds")
lung_res_late.1 <- readRDS("../Results/univ/univ_lung_res_latediag_1.rds")
lung_res_late.2 <- readRDS("../Results/univ/univ_lung_res_latediag_2.rds")

bladder_res_early.1 <- readRDS("../Results/univ/univ_bladder_res_earlydiag_1.rds")
bladder_res_early.2 <- readRDS("../Results/univ/univ_bladder_res_earlydiag_2.rds")
bladder_res_late.1 <- readRDS("../Results/univ/univ_bladder_res_latediag_1.rds")
bladder_res_late.2 <- readRDS("../Results/univ/univ_bladder_res_latediag_2.rds")


smokingNA=matrix(NA, nrow=4, ncol=4)
rownames(smokingNA)=rownames(lung_res_early.1[["smoking"]]$glm_output)
...
forest=cbind(foo(lung_res_early.1),foo(lung_res_early.2, smoking = T),
             foo(lung_res_late.1),foo(lung_res_late.2, smoking = T),
             foo(bladder_res_early.1),foo(bladder_res_early.2, smoking = T),
             foo(bladder_res_late.1),foo(bladder_res_late.2, smoking = T))
saveRDS(forest, "../Results/forest_plot_timediag.rds")
...
mycex=0.45
background=TRUE
mycols=darken(c("navy", "orange", "forestgreen", "tomato"), amount=0.2)

# lung
{pdf("../Figures/time_diag_lung_wk8.pdf", height = 10, width = 15)
  par(mar=c(17, 1, 3, 5))
  plotCI(x=xseq-1.5, y=forest$or_lung_early.1, li=forest$l95_lung_early.1, ui=forest$u95_lung_early.1, 
         ylim=c(0,10), 
         xlim=c(min(xseq), max(xseq)),
         xaxt="n", yaxt="n", pch=mypch, col=mycols[1], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="")
  ...
  plotCI(x=xseq-1.5, y=forest$or_lung_early.1, li=forest$l95_lung_early.1, ui=forest$u95_lung_early.1,
         ...
         xaxt="n", yaxt="n", pch=mypch, col=mycols[1], lwd=1, cex=mycex+0.2, sfrac=0.001,
         ylab="",xlab="", add=TRUE)
  plotCI(x=xseq-0.5, y=forest$or_lung_early.2, li=forest$l95_lung_early.2, ui=forest$u95_lung_early.2, 
         ylim=c(0,10), #ylim=myrange,
         xaxt="n", yaxt="n", pch=15, col=mycols[2], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=2)
  plotCI(x=xseq+0.5, y=forest$or_lung_late.1, li=forest$l95_lung_late.1, ui=forest$u95_lung_late.1, 
         ylim=c(0,10), #ylim=myrange,
         xaxt="n", yaxt="n", pch=19, col=mycols[3], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=3)
  plotCI(x=xseq+1.5, y=forest$or_lung_late.2, li=forest$l95_lung_late.2, ui=forest$u95_lung_late.2, 
         ylim=c(0,10), #ylim=myrange,
         xaxt="n", yaxt="n", pch=4, col=mycols[4], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=4)
  axis(side=4, at=axTicks(2), cex.axis=0.7)
  ...
  for (k in 1:length(xseq)){
    mytext=mynames
    axis(side=1, at=xseq[k], labels=mytext[k], 
         col=ifelse(forest$logp_lung_late.1 > bonf & forest$logp_lung_late.2 > bonf & 
                      forest$logp_lung_early.1 > bonf & forest$logp_lung_early.2 > bonf, yes=mycols[3], no="black"),
         las=2, cex.axis=0.7)
  }
  legend("topright", pch = c(mypch, 15, 19, 4), col = mycols, 
         legend = c("<Median Time to Diag Base","<Median Time to Diag Smoking", ">Median Time to Diag Base",">Median Time to Diag Smoking"))
  dev.off()}

# Bladder

{pdf("../Figures/time_diag_bladder_wk8.pdf", height = 10, width = 15)
  par(mar=c(17, 1, 3, 5))
  plotCI(x=xseq-1.5, y=forest$or_bladder_early.1, li=forest$l95_bladder_early.1, ui=forest$u95_bladder_early.1, 
         ylim=c(0,6), 
         xlim=c(min(xseq), max(xseq)),
         xaxt="n", yaxt="n", pch=mypch, col=mycols[1], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="")
  ...
  plotCI(x=xseq-1.5, y=forest$or_bladder_early.1, li=forest$l95_bladder_early.1, ui=forest$u95_bladder_early.1,
         ...
         xaxt="n", yaxt="n", pch=mypch, col=mycols[1], lwd=1, cex=mycex+0.2, sfrac=0.001,
         ylab="",xlab="", add=TRUE)
  plotCI(x=xseq-0.5, y=forest$or_bladder_early.2, li=forest$l95_bladder_early.2, ui=forest$u95_bladder_early.2, 
         ylim=c(0,6), #ylim=myrange,
         xaxt="n", yaxt="n", pch=15, col=mycols[2], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=2)
  plotCI(x=xseq+0.5, y=forest$or_bladder_late.1, li=forest$l95_bladder_late.1, ui=forest$u95_bladder_late.1, 
         ylim=c(0,6), #ylim=myrange,
         xaxt="n", yaxt="n", pch=19, col=mycols[3], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=3)
  plotCI(x=xseq+1.5, y=forest$or_bladder_late.2, li=forest$l95_bladder_late.2, ui=forest$u95_bladder_late.2, 
         ylim=c(0,6), #ylim=myrange,
         xaxt="n", yaxt="n", pch=4, col=mycols[4], lwd=1, cex=mycex, sfrac=0.001,
         ylab="",xlab="", add=TRUE, slty=4)
  axis(side=4, at=axTicks(2), cex.axis=0.7)
  ...
  for (k in 1:length(xseq)){
    mytext=mynames
    axis(side=1, at=xseq[k], labels=mytext[k], 
         col=ifelse(forest$logp_bladder_late.1 > bonf & forest$logp_bladder_late.2 > bonf & 
                      forest$logp_bladder_early.1 > bonf & forest$logp_bladder_early.2 > bonf, yes=mycols[3], no="black"),
         las=2, cex.axis=0.7)
  }
  legend("topright", pch = c(mypch, 15, 19, 4), col = mycols, 
         legend = c("<Median Time to Diag Base","<Median Time to Diag Smoking", ">Median Time to Diag Base",">Median Time to Diag Smoking"))
