### TDS Project -- Stability selection LASSO Logistic Regression Visualisation (Multi-panel for report)
...
ifelse(dir.exists("../../Figures/lasso_panels"),"",dir.create("../../Figures/lasso_panels"))
setwd("../../Figures/lasso_panels")
{pdf("lung_force.pdf", width=12, height=10)
  par(oma=c(17, 1, 3, 4), mar=c(0.5, 0, 0, 0.5), mfrow=c(2,1))
...
{pdf("bladder_force.pdf", width=12, height=10)
  par(oma=c(17, 1, 3, 4), mar=c(0.5, 0, 0, 0.5), mfrow=c(2,1))
...
{pdf("lung_denoise.pdf", width=12, height=10)
  par(oma=c(17, 1, 3, 4), mar=c(0.5, 0, 0, 0.5), mfrow=c(2,1))
...
{pdf("bladder_denoise.pdf", width=12, height=10)
  par(oma=c(17, 1, 3, 4), mar=c(0.5, 0, 0, 0.5), mfrow=c(2,1))
