...
# Save plots
pdf(paste0("../Results/PLS_319/train_test_spls/sPLS_TT_out_",arr,".pdf"), height=5, width=12)
...
# Save
saveRDS(out_1, paste0("../Results/PLS_319/train_test_spls/sPLS_TT_out_",arr, ".rds"))

saveRDS(average_load.1, paste0("../Results/PLS_319/train_test_spls/sPLS_TT_load_",arr, ".rds"))

saveRDS(selprop.1, paste0("../Results/PLS_319/train_test_spls/sPLS_TT_selprop_",arr,".rds"))
...
saveRDS(myroc, paste0("../Results/PLS_319/train_test_spls/sPLS_auc_",arr,".rds"))
...
saveRDS(myroc_re_1, paste0("../Results/PLS_319/train_test_spls/sPLS_auc_recali_",arr,".rds"))
